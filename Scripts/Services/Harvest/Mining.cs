...
namespace Server.Engines.Harvest
{
    public class Mining : HarvestSystem
    {
        ...
        private Mining()
        {
            ...
            oreAndStone.ConsumedPerHarvest = 8;
            oreAndStone.ConsumedPerFeluccaHarvest = 8;
            ...
            if (Core.ML)
            {
                ...
                {
                    new BonusHarvestResource(0, 92, null, null), //Nothing
                    new BonusHarvestResource(100, 1.0, 1072562, typeof(BlueDiamond)),
                    new BonusHarvestResource(100, 1.0, 1072567, typeof(DarkSapphire)),
                    new BonusHarvestResource(100, 1.0, 1072570, typeof(EcruCitrine)),
                    new BonusHarvestResource(100, 1.0, 1072564, typeof(FireRuby)),
                    new BonusHarvestResource(100, 1.0, 1072566, typeof(PerfectEmerald)),
                    new BonusHarvestResource(100, 1.0, 1072568, typeof(Turquoise)),
                    new BonusHarvestResource(100, 1.0, 1077180, typeof(SmallPieceofBlackrock)),
                    new BonusHarvestResource(100, 1.0, 1113344, typeof(CrystallineBlackrock), Map.TerMur)
				};
            }
            ...
            sand.ConsumedPerHarvest = 8;
            sand.ConsumedPerFeluccaHarvest = 8;
